...
from handlers.comment import CommentAddHandler, CommentListHandler, CommentDeleteHandler
...
app = webapp2.WSGIApplication([
    ...
    webapp2.Route('/topic/<topic_id:\d+>/comment/<comment_id:\d+>/delete', CommentDeleteHandler, name='comment-delete'),
